...
namespace HotelProject.WebUI.ViewComponents.Dashboard
{
                ...
                Headers =
    {
        ...
        { "X-RapidAPI-Host", "instagram-profile1.p.rapidapi.com" },
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri("https://twitter32.p.rapidapi.com/getProfile?username=atayaliko"),
                Headers =
    {
        { "X-RapidAPI-Key", "a185ef643bmshb75535aa8ebaae4p1b9d04jsn9c6a63a3b48d" },
        { "X-RapidAPI-Host", "twitter32.p.rapidapi.com" },
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri("https://fresh-linkedin-profile-data.p.rapidapi.com/get-linkedin-profile?linkedin_url=https%3A%2F%2Fwww.linkedin.com%2Fin%2Fcaglaaksoy1%2F"),
                Headers =
    {
        { "X-RapidAPI-Key", "a185ef643bmshb75535aa8ebaae4p1b9d04jsn9c6a63a3b48d" },
        { "X-RapidAPI-Host", "fresh-linkedin-profile-data.p.rapidapi.com" },
            ...
            using (var response3 = await client3.SendAsync(request3))
            {
                ...
                ResultLinkednFollowersDto resultLinkednFollowersDto = JsonConvert.DeserializeObject<ResultLinkednFollowersDto>(body3);
                ViewBag.v5 = resultLinkednFollowersDto.data.followers_count;
